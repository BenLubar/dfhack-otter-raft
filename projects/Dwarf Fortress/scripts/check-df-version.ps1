...
@{'If-None-Match' = $lastETag; 'If-Modified-Since' = $lastModified; 'User-Agent' = 'DFHack-release-monitor (+https://buildmaster.lubar.me/applications/32/)'} | Export-Clixml input.xml
